...
model_anemia_child <- lm(z_anemia_child ~ z_hdi, data = data) |>
  tbl_regression(
    conf.int = TRUE,
    conf.level = 0.95,
...
model_anemia_gest <- lm(z_anemia_gest ~ z_hdi, data = data) |>
  tbl_regression(
    conf.int = TRUE,
    conf.level = 0.95,
    tidy_fun = broom.helpers::tidy_parameters,
...
model_anemia_fertil <- lm(z_anemia_fertil ~ z_hdi, data = data) |>
  tbl_regression(
    conf.int = TRUE,
    conf.level = 0.95,
    tidy_fun = broom.helpers::tidy_parameters,
...
model_bpn <- lm(z_bpn ~ z_hdi, data = data) |>
  tbl_regression(
    conf.int = TRUE,
    conf.level = 0.95,
    tidy_fun = broom.helpers::tidy_parameters,
...
model_tallaedad <- lm(z_tallaedad ~ z_hdi, data = data) |>
  tbl_regression(
    conf.int = TRUE,
    conf.level = 0.95,
    tidy_fun = broom.helpers::tidy_parameters,
...
model_sobrepeso <- lm(z_sobrepeso ~ z_hdi, data = data) |>
  tbl_regression(
    conf.int = TRUE,
    conf.level = 0.95,
    tidy_fun = broom.helpers::tidy_parameters,
...
# vcov_cluster_ns_anemia_child <- vcovCR(ns_anemia_child, cluster = datos$pais, type = "CR2")
vcov_cluster_ns_anemia_gest <- vcovCL(ns_anemia_gest, cluster = ~pais)
vcov_cluster_ns_anemia_fertil <- vcovCL(ns_anemia_fertil, cluster = ~pais)
vcov_cluster_ns_bpn <- vcovCL(ns_bpn, cluster = ~pais)
vcov_cluster_ns_tallaedad <- vcovCL(ns_tallaedad, cluster = ~pais)
vcov_cluster_ns_sobrepeso <- vcovCL(ns_sobrepeso, cluster = ~pais)
